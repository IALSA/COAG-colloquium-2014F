...
[watch online](https://www.popdata.bc.ca/node/2035)  </br>   
...
Introduction to Latent Class and Latent Transition Models: Matching Models to Questions to Data. </br> 

</br>
**Nov 4, 2014**  
Andrey Koval (University of Victoria)  
[RR Basic Skills (2): Graph Production][lecture3]  
...
**Nov 18, 2014**   
Andrey Koval (University of Victoria)    
[RR Basic Skills (3): Statistical modeling][lecture4]    
The lecture introduces model fitting in R and discusses popular packages for estimating statistical 
models (nlme, lme4, etc.). Fitting of linear and mixed models of longitudinal data is demonstrated. 
The strategy of organizing and post-processing of the model output is discussed. 
[watch online](https://www.popdata.bc.ca/node/2035)  </br>  

**Nov 25, 2014**  
The presentation has been rescheduled to next week, December 2. 
The lecture "Migrating into R from other Statistical Software" has been moved to the spring 2015 semester. 
This rescheduling will assist with better alignment of presentation topics and will address logistical considerations associated with instructor availability. 

**Dec 2, 2014**  
Andrey Koval (University of Victoria)  
[RR Basic Skills (4): Dynamic Reporting][lecture5]  
...
**VIDEO DOWNLOAD**  
If you wish to view this video on your computer, first click on the play arrow, then right click your mouse and select the 'save as' option. This will allow you to save the video to your computer as an Mp4 file.
...
[lecture3]:./2014-11-04-Producing-Graphs.html
[lecture4]:./2014-11-18-Statistical-Modeling.html
[lecture5]:./2014-12-02-Dynamic-Reporting.html
