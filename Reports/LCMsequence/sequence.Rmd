...
## R2 by row
```{r R2_row, echo=echoChunks, results="hide" , warning=warningChunks, message=messageChunks,  fig.height= figHightChunkSequence} 
```

## R2 by column
```{r R2_col, echo=echoChunks, results="hide" , warning=warningChunks, message=messageChunks,  fig.height= figHightChunkSequence} 
```
...
## R3 by row
```{r R3_row, echo=echoChunks, results="hide" , warning=warningChunks, message=messageChunks,  fig.height= figHightChunkSequence} 
```

## R3 by column
```{r R3_col, echo=echoChunks, results="hide" , warning=warningChunks, message=messageChunks,  fig.height= figHightChunkSequence} 
```
...
<img src = 'models/formulas/spec_tall.png' width="100%"></img> 
