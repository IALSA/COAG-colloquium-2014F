...
## Preview
```{r graphFinalpreview, echo=F, warning=F, message=F, out.width="100%"}
```
...
## Geom: point
```{r graph01, echo=T, warning=F, message=F, out.width="700px"}
```

## Geom: line
```{r graph02, echo=T, warning=F, message=F, out.width="700px"}
```


## Geom: line + point
```{r graph03, echo=T, warning=F, message=F, out.width="700px"}
```


## Define theme
```{r loadTheme, echo=T, warning=F, message=F, out.width="700px"}
```

## Add theme
```{r graph04, echo=T, warning=F, message=F, out.width="700px"}
```
...
```
## Scales: X-Axis
```{r graph05, echo=F, warning=F, message=F, out.width="700px"}
```

## Scales: y-Axis
```{r graph06, echo=F, warning=F, message=F, out.width="700px"}
```


## Add title
```{r graph07, echo=F, warning=F, message=F, out.width="700px"}
```

## Multiple Lines
```{r graph08, echo=F, warning=F, message=F, out.width="700px"}
```

## Multiple Lines with grouping
```{r graph09, echo=F, warning=F, message=F, out.width="700px"}
```

## Edit geoms
```{r graph10, echo=F, warning=F, message=F, out.width="700px"}
```


## Facet
```{r graph11, echo=F, warning=F, message=F, out.width="700px"}
```



----
```{r graphFinal, echo=F, warning=F, message=F, out.width="100%"}
```
